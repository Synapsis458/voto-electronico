  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-3xl">
        <Link
          href="/"
          className="mb-4 inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-blue-800 dark:text-slate-400 dark:hover:text-blue-300"
        >
        ...
        <div className="frame-gradient rounded-[2rem] shadow-2xl shadow-blue-950/10">
          <div className="rounded-[calc(2rem-1.5px)] bg-white/90 backdrop-blur-sm dark:bg-slate-900/90">
            <div className="px-6 pb-6 pt-8 text-center sm:px-10 sm:pt-10">
              ...
              <span className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-rose-50 px-3 py-1 text-xs font-semibold text-rose-700 dark:bg-rose-950 dark:text-rose-400">
