    ...
    <div className="flex flex-1 items-center justify-center bg-zinc-50 px-4 dark:bg-black">
      ...
      >
        ...
        <p className="mt-1 text-sm text-zinc-500">
          Sistema de Voto Electrónico Escolar
        </p>
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={pending}
            className="mt-2 rounded-lg bg-zinc-900 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-zinc-700 disabled:opacity-60 dark:bg-zinc-100 dark:text-zinc-900"
          >
